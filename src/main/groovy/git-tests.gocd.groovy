...
final def versions = ["2.22.0", "2.21.0", "2.20.1", "2.19.2", "2.18.1", "2.17.2", "2.16.5", "2.15.3", "2.14.5", "2.13.7", "2.12.5", "2.11.4",
...
private static Job gitTestJob(String git_version) {
    new Job("test-${git_version}", {
        ...
        tasks {
            exec {
                commandLine = ['sudo', 'yum', 'remove', '-y', 'rh-git29']
            }
            exec {
                commandLine = ['sudo', 'rm', '-rf', '/opt/rh/rh-git29/']
            }
            exec {
